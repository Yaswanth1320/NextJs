...
export default function Curosel() {
  return (
    <div
      id="default-carousel"
      className="relative w-full flex-4 p-4 bg-[#1E1919] dark:bg-slate-800 h-full"
      data-carousel="slide"
    >
      <div className="relative h-56 overflow-hidden rounded-lg md:h-96">
        <div className="hidden duration-700 ease-in-out" data-carousel-item>
          <Image
            src="/img1.jpg"
            className="absolute z-30  block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
            width={500}
            height={300}
            alt="1"
          />
