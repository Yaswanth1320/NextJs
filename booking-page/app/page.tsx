...
export default function Home() {
  return (
    <>
      <div className="font-abc bg-[#344e41] pb-6">
        ...
        <section className="mx-auto max-w-[1120px] mt-10 p-6 bg-white rounded-lg">
          <div className="pt-5">
      ...
      <section className="w-full bg-white font-abc max-w-[1120px] mx-auto p-6">
        <Places />
      </section>
      <Footer/>
    </>
